    ...
    <>
        ...
        <header className="nav">
          <div className="wrap navInner">
            ...
            <nav className="links" aria-label="Navigation">
              ...
              <a href="#faq">FAQ</a>
              <a className="ctaNav" href="/builder">Créer mon site</a>
            </nav>
          </div>
        </header>
        ...
        <section id="top" className="hero">
          ...
          <div className="wrap heroGrid">
            <div className="heroLeft">
              ...
              <Reveal delay={140}>
                <p className="lead">
                  Vous répondez à quelques questions. On génère une vitrine claire,
                  élégante et orientée contact (image IA incluse), puis vous recevez
                  l’URL par email.
                </p>
              </Reveal>
              ...
              <Reveal delay={200}>
                <div className="ctaRow">
                  <a className="ctaPrimary" href="/builder">Créer mon site maintenant</a>
                  <a className="ctaGhost" href="#exemples">Voir des exemples</a>
                </div>
                <div className="micro">
            ...
            <div className="heroRight" style={{ transform: heroParallax }}>
              <Reveal delay={120} className="stack">
                <div className="device">
                  ...
                  <div className="deviceBody">
                    ...
                    <div className="bullets">
                      <div className="bullet"><b>✔</b> Infos essentielles visibles</div>
                      <div className="bullet"><b>✔</b> Formulaire prêt à convertir</div>
                      <div className="bullet"><b>✔</b> Image IA premium</div>
                      <div className="bullet"><b>＋</b> Option Betty (assistante IA)</div>
                    </div>
                  </div>
                ...
                <div className="kpis" aria-hidden="true">
                  <div className="kpi"><div className="kpiN">1€</div><div className="kpiL">par mois</div></div>
                  <div className="kpi"><div className="kpiN">3</div><div className="kpiL">minutes</div></div>
                  <div className="kpi"><div className="kpiN">24/7</div><div className="kpiL">visible</div></div>
                </div>
              </Reveal>
            </div>
          </div>
          ...
          <div className="wrap">
            <Reveal>
              <div className="head">
                ...
                <p className="sub">
                  Rendu premium : survole pour voir l’overlay, le zoom, les détails.
                </p>
              </div>
            </Reveal>
            ...
            <div className="exGrid">
              <Reveal delay={0}>
                <ExampleCard img="/site1euroeste.png" title="Esthéticienne" tag="Beauté • RDV" city="Le Mans" />
              </Reveal>
              <Reveal delay={120}>
                <ExampleCard img="/site1euroimmo.png" title="Agent immobilier" tag="Immo • Estimation" city="Nantes" />
              </Reveal>
              <Reveal delay={240}>
                <ExampleCard img="/site1euroarti.png" title="Artisan" tag="Devis • Intervention" city="Angers" />
              </Reveal>
            </div>

            <Reveal delay={220}>
              <div className="center">
                <a className="ctaPrimary" href="/builder">Je crée mon site (1€)</a>
          ...
          <div className="wrap">
            <Reveal>
              <div className="head">
                ...
                <p className="sub">Tu remplis → on génère → tu reçois l’URL.</p>
              </div>
            </Reveal>
            ...
            <div className="steps">
              ...
              <Reveal delay={240}>
                <div className="step">
                  ...
                  <p>Ton site est en ligne. Tu le partages immédiatement.</p>
                </div>
              </Reveal>
            </div>
            ...
            <Reveal delay={240}>
              <div className="banner">
                <div>
                  ...
                  <div className="bannerS">Ajoute Betty ensuite : réponses 24/7 + leads qualifiés.</div>
                </div>
                <div className="bannerBtns">
                  <a className="ctaPrimary" href="/builder">Démarrer</a>
                  <a className="ctaGhost" href="#faq">Voir la FAQ</a>
                </div>
              </div>
            </Reveal>
          </div>
          ...
          <div className="wrap">
            <Reveal>
              <div className="head">
                ...
                <p className="sub">Landing pro = confiance. Confiance = demandes.</p>
              </div>
            </Reveal>
            ...
            <div className="proofs">
              <Reveal delay={0}>
                <div className="proofCard">
                  ...
                  <div className="proofText">Paiement sécurisé, mensuel, annulation immédiate.</div>
                </div>
              </Reveal>
              ...
              <Reveal delay={240}>
                <div className="proofCard">
                  ...
                  <div className="proofText">Structure calibrée selon activité + ville.</div>
                </div>
              </Reveal>
            </div>
          </div>
          ...
          <div className="wrap">
            <Reveal>
              <div className="head">
                ...
                <p className="sub">Réponses nettes.</p>
              </div>
            </Reveal>
            ...
            <div className="faq">
              <Reveal delay={0}>
                <details className="qa">
                  ...
                  <div className="qaBody">
                    Offre d’entrée simple : tu testes sans stress. Résiliable quand tu veux.
                  </div>
                </details>
              </Reveal>
              ...
              <Reveal delay={80}>
                <details className="qa">
                  ...
                  <div className="qaBody">
                    Après création via le builder : email envoyé avec ton lien.
                  </div>
                </details>
              </Reveal>
              ...
              <Reveal delay={160}>
                <details className="qa">
                  ...
                  <div className="qaBody">
                    Oui : réponse 24/7 + qualification (nom/email/téléphone/besoin).
                  </div>
                </details>
              </Reveal>
              ...
              <Reveal delay={240}>
                <details className="qa">
                  ...
                  <div className="qaBody">Oui. Mensuel, annulable à tout moment.</div>
                </details>
              </Reveal>
            </div>
            ...
            <Reveal delay={240}>
              <div className="center">
                <a className="ctaPrimary" href="/builder">Ok, je le fais (1€)</a>
                <div className="micro">Tu peux avoir un rendu propre aujourd’hui.</div>
              </div>
            </Reveal>
          </div>
        </section>
      ...
      <style jsx global>{`
        ...
        *{box-sizing:border-box}
        ...
        .links a{
          text-decoration:none;font-size:13px;opacity:.86;
        ...
        .ctaPrimary{
          text-decoration:none;font-weight: 980;font-size: 14px;
          padding: 14px 18px;border-radius: 999px;color: #06121d;
        ...
        .ctaGhost{
          text-decoration:none;font-weight: 930;font-size: 14px;
        ...
        .device{
          border-radius: 24px;border: 1px solid rgba(148,163,184,.20);
        ...
        .live{
          font-size:11px;font-weight:980;letter-spacing:.14em;
        ...
        .heroMock{
          height: 220px;border-radius: 18px;border: 1px solid rgba(148,163,184,.14);
          background:
        ...
        .heroMockShade{position:absolute; inset:0; background: linear-gradient(180deg, rgba(0,0,0,.06), rgba(0,0,0,.78))}
        .heroMockTxt{position:absolute; left:0; right:0; bottom:0; padding: 14px}
        ...
        .mockBtn{
          ...
          padding: 9px 11px;border-radius: 999px;font-size: 12px;font-weight: 930;
          background: rgba(250,204,21,.18);border: 1px solid rgba(250,204,21,.22);
        }
        .mockBtn.ghost{background: rgba(255,255,255,.04);border: 1px solid rgba(148,163,184,.16)}
        .bullets{margin-top: 12px;display:grid;grid-template-columns: 1fr 1fr;gap: 10px}
        .bullet{
          font-size:13px;padding: 10px 12px;border-radius: 14px;
          border: 1px solid rgba(148,163,184,.14);
          background: rgba(255,255,255,.03);
        ...
        .sticky{position: fixed;right: 16px;bottom: 16px;z-index: 60;pointer-events:none}
        .stickyBtn{
          pointer-events:auto;
          display:inline-flex;align-items:center;gap:10px;
          text-decoration:none;font-weight:980;font-size:13px;
        ...
        .stickyStar{
          ...
          background: radial-gradient(circle at 30% 30%, #fff, #facc15 55%, #fb7185 100%);
          clip-path: polygon(50% 0%, 61% 26%, 89% 28%, 68% 45%, 76% 72%, 50% 57%, 24% 72%, 32% 45ndㅤ
          45%, 11% 28%, 39% 26%);
        ...
        .exGrid{display:grid;grid-template-columns: repeat(3, minmax(0,1fr));gap: 14px}
        @media (max-width: 980px){ .exGrid{grid-template-columns:1fr} }

        .exCard{
          text-decoration:none;border-radius: 26px;overflow:hidden;
          border: 1px solid rgba(148,163,184,.16);
          background: rgba(255,255,255,.03);
        ...
        .exMedia img{width:100%; height:100%; object-fit: cover; display:block; transform: scale(1.02); transition: transform .35s ease}
        ...
        .chip{
          font-size:11px;font-weight:980;letter-spacing:.14em;text-transform:uppercase;
          padding:7px 10px;border-radius:999px;
          border:1px solid rgba(250,204,21,.28);
          background: rgba(250,204,21,.12);
        }
        .chip.ghost{border:1px solid rgba(148,163,184,.16);background: rgba(255,255,255,.04);opacity:.9}
        ...
        .tag{padding:6px 10px;border-radius:999px;border:1px solid rgba(148,163,184,.16);background: rgba(255,255,255,.04)}
        ...
        .miniBtn{font-size:12px;font-weight:930;padding:8px 10px;border-radius:999px;border:1px solid rgba(250,204,21,.22);background: rgba(250,204,21,.12)}
        .miniBtn.ghost{border:1px solid rgba(148,163,184,.16);background: rgba(255,255,255,.04)}
        ...
        .banner{
          margin-top: 18px;border-radius: 24px;border: 1px solid rgba(148,163,184,.18);
          background:
            ...
            rgba(255,255,255,.03);
          padding: 16px;display:flex; gap:14px; align-items:center; justify-content:space-between;
          flex-wrap:wrap;box-shadow: 0 24px 90px rgba(0,0,0,.35);
        }
        ...
        .proofCard{
          border-radius: 22px;border: 1px solid rgba(148,163,184,.16);
          background: rgba(255,255,255,.03);
          padding: 16px;box-shadow: 0 18px 55px rgba(0,0,0,.25);
        }
        ...
        .qa{
          ...
          background: rgba(255,255,255,.03);
          padding: 12px 14px;box-shadow: 0 18px 55px rgba(0,0,0,.18);
        }
        ...
        .footer{padding: 26px 0;border-top: 1px solid rgba(148,163,184,.12);background: rgba(2,6,23,.78)}
        ...
        .footLinks a{
          text-decoration:none;font-size:13px;opacity:.84;padding:8px 10px;border-radius:999px;
          border:1px solid rgba(148,163,184,.14);background: rgba(255,255,255,.03);
        }
