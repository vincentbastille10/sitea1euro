...
export async function sendSiteEmail(site) {
  ...
  const T = lang === "en" ? {
    ...
    cta: "See my website →",
    payCta: "Start my 14-day free trial →",
    ...
    price: withBetty
      ? "Website + your Betty assistant included — 14 days free, then $59/month. Cancel anytime, pay nothing if you cancel."
      : "Professional website — 14 days free, then $59/month, cancel anytime",
    ...
    cta: "Voir mon site →",
    payCta: "Activer mon essai gratuit 14 jours →",
    ...
    price: withBetty
      ? "Site vitrine + votre assistante Betty incluse — 14 jours gratuits, puis 59 €/mois. Annulez avant, vous ne payez rien."
      : "Site vitrine professionnel — 14 jours gratuits, puis 59 €/mois, sans engagement",
