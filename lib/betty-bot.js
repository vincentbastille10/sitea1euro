...
// Packs dont l'avatar est un HOMME → accord masculin en français
// (« Betty, l'assistant virtuel » au lieu de « l'assistante virtuelle »).
const MALE_PACKS = new Set([
...
export async function upsertProspectBot({ email, pack, botKey, name, metierLabel, lang, phone = "", address = "", website = "", trialDays = 14 }) {
  ...
  const greeting = greetingFor(metierLabel || name, lang, MALE_PACKS.has((pack || "").toLowerCase()));
