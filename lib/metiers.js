...
export const METIERS = [
  ...
  { id: "dentiste", label: "Dentiste", pack: "betty_dentiste", lang: "en",
  ...
  { id: "avocat", label: "Avocat / cabinet", pack: "avocat", lang: "en",
  ...
  { id: "veterinaire", label: "Vétérinaire", pack: "betty_veterinaire", lang: "en",
  ...
  { id: "kine", label: "Kiné / physio", pack: "betty_kine", lang: "en",
  ...
  { id: "nutritionniste", label: "Nutritionniste / diététicien", pack: "betty_nutritioniste", lang: "en",
  ...
  { id: "garagiste", label: "Garagiste / mécanicien", pack: "betty_mecano", lang: "en",
    pitch: "Betty takes repair requests and quotes at any hour.",
    imagePrompt: "clean professional auto repair garage, tools, modern" },
  { id: "serrurier", label: "Serrurier", pack: "betty_serrurier", lang: "en",
  ...
  { id: "traiteur", label: "Traiteur", pack: "betty_traiteur", lang: "en",
  ...
  { id: "assurance", label: "Assurance / courtier", pack: "betty_assurance", lang: "en",
    pitch: "Betty qualifies enquiries and books calls 24/7.",
    imagePrompt: "professional insurance office, modern, reassuring, bright" },
  { id: "marketing", label: "Agence marketing", pack: "betty_marketing", lang: "en",
  ...
  { id: "menage", label: "Ménage / entretien", pack: "betty_menage", lang: "en",
