...
export const METIERS = [
  ...
  },
  {
    ...
    betty_public_id: "demo-realtor",
    pitch:
      "Vos demandes de booking trouvent une réponse à toute heure. Betty présente vos prestations, vérifie vos disponibilités et capte chaque contact — même quand vous êtes derrière les platines.",
    imagePrompt:
      "professional DJ performing behind turntables and a mixing console, dark club with colorful stage lighting, energetic nightlife atmosphere, crowd silhouettes",
  },
];
